...
class PilotsControllerTest < ActionController::TestCase
  ...
  test "should create pilot" do
    assert_difference('Pilot.count') do
      post :create, pilot: { cod_avion_id: @pilot.cod_avion_id, identificacion: @pilot.identificacion, nombre: @pilot.nombre, route_id: @pilot.route_id }
    end
  ...
  test "should update pilot" do
    patch :update, id: @pilot, pilot: { cod_avion_id: @pilot.cod_avion_id, identificacion: @pilot.identificacion, nombre: @pilot.nombre, route_id: @pilot.route_id }
    assert_redirected_to pilot_path(assigns(:pilot))
  end
