...
class PassengersControllerTest < ActionController::TestCase
  ...
  test "should create passenger" do
    assert_difference('Passenger.count') do
      post :create, passenger: { fecha_id: @passenger.fecha_id, identificacion: @passenger.identificacion, nombre: @passenger.nombre, route_id: @passenger.route_id }
    end
  ...
  test "should update passenger" do
    patch :update, id: @passenger, passenger: { fecha_id: @passenger.fecha_id, identificacion: @passenger.identificacion, nombre: @passenger.nombre, route_id: @passenger.route_id }
    assert_redirected_to passenger_path(assigns(:passenger))
  end
